...
void ASnd::Play(float volume)
{
	assert(this->pPlaylist);
	this->pPlaylist->poCmd->SetVolume(volume);
...
void ASnd::Volume(float volume)
{
	assert(this->pPlaylist);
	this->pPlaylist->poVolumeCmd->SetVolume(volume);
	this->pPlaylist->poVolumeCmd->Execute();
